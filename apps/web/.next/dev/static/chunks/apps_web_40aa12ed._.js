...
function LoginPage() {
    ...
    const handleSubmit = async ()=>{
        ...
        setLoading(true);
        if (isLogin) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
            if (error) {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                email,
                password
            });
            if (error) {
...
_s(LoginPage, "ZG+8vNBhx+TCgtCTHc0PQqQirFY=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_40aa12ed._.js.map