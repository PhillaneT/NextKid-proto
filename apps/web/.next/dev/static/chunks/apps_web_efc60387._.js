...
function BrowsePage() {
    ...
    async function fetchItems() {
        ...
        if (user) {
            const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('is_age_verified').eq('id', user.id).single();
            setIsAgeVerified(profile?.is_age_verified || false);
        }
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('items').select('*').order('created_at', {
            ascending: false
        });
...
_s(BrowsePage, "mpqlLQX73dKwySpjcBuTP5n3l/8=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_efc60387._.js.map